<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex items-center">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="top" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('clients.index')" :active="request()->routeIs('clients.*')">Clientes</x-dropdown-link>
                                <x-dropdown-link :href="route('proposals.index')" :active="request()->routeIs('proposals.*')">Propostas</x-dropdown-link>
                                <x-dropdown-link :href="route('stats.index')" :active="request()->routeIs('stats.*')">Meus Resultados</x-dropdown-link>
                                <div class="border-t border-gray-100 my-1"></div>
                                <x-dropdown-link :href="route('reports.efficiency')" :active="request()->routeIs('reports.efficiency')">
                                    Minha Eficiência (Funil)
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="top" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('proposals.index', ['status' => 'em_analise'])">Aprovações Pendentes</x-dropdown-link>
                                <div class="border-t border-gray-100 my-1"></div>
                                <x-dropdown-link :href="route('finance.audit')" :active="request()->routeIs('finance.audit')">Auditoria / Logs</x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    @endif
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="top" width="56"> 
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('reports.team-ranking')" :active="request()->routeIs('reports.team-ranking')">🏆 Ranking de Vendas</x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('reports.team-ranking')" :active="request()->routeIs('reports.team-ranking')">🏆 Ranking de Vendas</x-responsive-nav-link>
            ...
            @if(Auth::user()->role == 'admin')
            <div class="pt-2 pb-1 border-t border-gray-200"><div class="px-4 text-xs text-gray-400 uppercase">Sistema</div></div>
