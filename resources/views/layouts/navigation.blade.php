<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="top" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('proposals.index')">Propostas</x-dropdown-link>
                                <x-dropdown-link :href="route('stats.index')">Meus Resultados</x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="top" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('finance.audit')">Auditoria / Logs</x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('finance.audit')">Auditoria / Logs</x-responsive-nav-link>
            @endif
